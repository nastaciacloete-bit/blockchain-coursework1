...
namespace BlockchainAssignment
{
    public partial class BlockchainApp : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e) //print into richTextBox1, part 1
        {
        ...
        private void button2_Click(object sender, EventArgs e) //generate wallet
        {
            string privateKey;
        ...
        private void button3_Click(object sender, EventArgs e)//validate wallet
        {
        ...
        private void button4_Click(object sender, EventArgs e) //create transaction
        {
            double amount;
            double fee;
        ...
        private void button5_Click(object sender, EventArgs e)//read pool
        {
            richTextBox1.Text = blockchain.ReadTransactionPool();
        }

        private void button6_Click(object sender, EventArgs e) //generate new block, updated for 6.1
        {
        ...
        private void button7_Click(object sender, EventArgs e)//read all
        {
            richTextBox1.Text = blockchain.ReadAllBlocks();
        }

        private void button8_Click(object sender, EventArgs e)//validate blockchain
        {
            richTextBox1.Text = blockchain.ValidateBlockchain();
        }

        private void button9_Click(object sender, EventArgs e) //chek balance
        {
